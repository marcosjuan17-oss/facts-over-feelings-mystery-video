...
*{box-sizing:border-box}html,body{margin:0;width:1080px;height:1920px;overflow:hidden;background:#03060d}.stage{position:relative;width:1080px;height:1920px;overflow:hidden;background:#040711 center/cover no-repeat;color:#f4f7fb}.shade{position:absolute;inset:0;background:linear-gradient(180deg,rgba(1,4,11,.08),rgba(1,4,11,.18) 38%,rgba(1,4,11,.03))}.pixel{font-family:Press}.silk{font-family:Silk}.toptrack{position:absolute;left:60px;top:52px;width:960px;height:10px;background:#263149}.topfill{height:100%;background:#ff561b}.brand{position:absolute;left:70px;top:84px;font:31px Press}.mode{position:absolute;left:70px;top:154px;font:18px Silk;color:#ff6428;letter-spacing:2px}.prompt{position:absolute;left:70px;top:210px;width:700px;font:46px/1.06 Press}.sub{font:17px Silk;color:#9cabc2;letter-spacing:2px}.hook{position:absolute;left:70px;top:255px;width:940px;text-align:center;font:62px/1.38 Press}.hooksub{position:absolute;left:70px;top:515px;width:940px;text-align:center;font:29px Press;color:#ff6125}.gamestart{position:absolute;left:70px;top:590px;width:940px;text-align:center;font:23px Silk;color:#24d8ff;letter-spacing:3px}.card{position:absolute;left:70px;width:760px;height:220px;border:2px solid #29354b;border-radius:10px;background:rgba(5,10,22,.93)}.card.active{border-color:#ff6a27}.status{position:absolute;left:35px;top:27px;font:20px Silk;color:#ff6428;letter-spacing:2px}.status.decode{color:#26d9ff}.cluetext{position:absolute;left:35px;top:88px;width:600px;font:27px/1.35 Press}.dots{position:absolute;right:145px;top:72px;color:#ff5b1d;font:48px Silk;letter-spacing:5px}.avatar{position:absolute;right:28px;top:42px;width:116px;height:116px;object-fit:contain;image-rendering:pixelated}.timer{position:absolute;left:850px;width:170px;height:220px;border:3px solid #ff6428;border-radius:12px;background:#080d19;text-align:center}.timerlabel{position:absolute;left:0;top:27px;width:100%;font:17px Silk;color:#9cabc2;letter-spacing:2px}.timernum{position:absolute;left:0;top:67px;width:100%;font:68px Press;text-align:center}.pips{position:absolute;left:16px;right:16px;bottom:30px;display:flex;gap:7px}.pip{height:13px;flex:1;border-radius:4px;background:#283249}.pip.on{background:#ff5b1d}.lock{position:absolute;left:70px;top:360px;width:940px;height:900px;border:4px solid #ff6428;border-radius:12px;background:rgba(3,7,16,.96);text-align:center}.locktitle{margin-top:82px;font:49px/1.35 Press}.locknum{margin-top:58px;font:180px Press;color:#ff5b1d}.locksite{margin-top:95px;font:28px Silk;color:#26d9ff;letter-spacing:2px}.reveal{position:absolute;left:70px;top:360px;width:940px;height:1420px;border:3px solid #ff6428;border-radius:12px;background:rgba(3,7,16,.95);text-align:center}.revealcap{margin-top:55px;font:29px Press}.player{margin:90px auto 0;width:860px;font:54px/1.28 Press;color:#ff5b1d}.celebrate{width:175px;height:175px;object-fit:contain;image-rendering:pixelated;margin-top:25px}.site{margin-top:16px;font:30px Silk;color:#26d9ff;letter-spacing:2px}.recap{margin:55px auto 0;width:820px;text-align:left}.recaprow{display:flex;gap:22px;margin:0 0 26px;font:21px/1.25 Press}.recaprow b{color:#ff6428}.particle{position:absolute;width:8px;height:8px;background:#ff6428}.flash{position:absolute;inset:0;background:white}.glitch{filter:contrast(1.14) saturate(1.18)}
...
const timer=(y,n)=>'<div class="timer" style="top:'+y+'px"><div class="timerlabel">SHOT CLOCK</div><div class="timernum">'+n+'</div><div class="pips">'+[5,4,3,2,1].map(v=>'<i class="pip '+(v<=n?'on':'')+'"></i>').join('')+'</div></div>';
